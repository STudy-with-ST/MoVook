...
public class MovieRestController {
	...
	@ApiOperation(value = "영화 검색", notes = "제목 검색 결과를 리턴합니다. 검색 결과는 DB에 자동으로 저장됩니다.")
	...
	@ApiOperation(value = "영화 추가", notes = "영화의 리뷰를 작성할 때 외래키 사용을 위해 영화 데이터를 추가합니다. 영화 검색시 자동으로 저장되지만, 데이터가 있는지 확실히 하기 위해 사용됩니다.")
	@PostMapping("/movie")
